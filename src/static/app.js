...
const translations = {
    ar: {
        ...
        welcomeInstant: "ابدأ الدردشة مع Instant",
        welcomeExpert: "ابدأ الدردشة مع Spark",
        promptPlaceholderChatgpt: "راسل ChatGPT...",
        promptPlaceholderGemini: "راسل Gemini...",
        promptPlaceholderDeepseek: "راسل DeepSeek..."
    },
    en: {
        pageTitle: "AI Spark",
        ...
        welcomeExpert: "Start chatting with Spark",
    ...
    fr: {
        ...
        welcomeInstant: "Commencez à discuter avec Instant",
        welcomeExpert: "Commencez à discuter avec Spark",
        promptPlaceholderChatgpt: "Envoyez un message à ChatGPT...",
        promptPlaceholderGemini: "Envoyez un message à Gemini...",
        promptPlaceholderDeepseek: "Envoyez un message à DeepSeek..."
    },
    es: {
        pageTitle: "AI Spark",
        subTitle: "Coordinador Inteligente Local",
        braveBrowser: "Navegador Brave",
        syncBtn: "Sincronizar",
        ...
        older: "Más antiguo",
        dashboardTitle: "Panel de Difusión Distribuida",
        dashboardDesc: "Escribe tu pregunta y el sistema la transmitirá simultáneamente a ChatGPT, Gemini y DeepSeek, luego la recopilará y resumirá localmente a través de Claude.",
        promptPlaceholder: "Escribe tu pregunta aquí en detalle... (ej. ¿Explica la computación en la nube y sus tipos?)",
        claudeSynthesisToggle: "Fusión y resumen final a través de Claude",
        sendPromptBtn: "Transmitir Pregunta y Recopilar Respuestas",
        progressTitle: "Ejecutando proceso de difusión y recopilación...",
        stepBroadcast: "Transmitiendo la pregunta a las pestañas abiertas...",
        stepCollect: "Esperando para recopilar respuestas (ChatGPT, Gemini, DeepSeek)...",
        stepSynth: "Enviando respuestas a Claude para un resumen unificado...",
        unifiedAnswerTitle: "Respuesta Final Unificada y Mejorada (Sintetizada por Claude)",
        copyBtn: "Copiar",
        chatgptAnswer: "ChatGPT",
        geminiAnswer: "Gemini",
        deepseekAnswer: "DeepSeek",
        footerText: "Construido 100% localmente sin APIs pagas",
        clearHistoryBtn: "Borrar Historial",
        clearHistoryConfirm: "¿Estás seguro de que deseas borrar todo el historial de chat?",
        modalAlertTitle: "Alerta",
        modalAlertMsg: "Asegúrate de que el navegador se esté ejecutando y las pestañas requeridas estén abiertas.",
        modalCancelBtn: "Cancelar",
        modalOkBtn: "Aceptar",
        
        alertError: "Error",
        alertSuccess: "Éxito",
        alertSelectAgent: "Selecciona al menos un asistente de IA.",
        alertEnterQuestion: "Por favor, escribe tu pregunta antes de enviarla.",
        alertCopySuccess: "¡Texto copiado al portapapeles!",
        alertBrowserAlreadyOpenTitle: "Navegador Ya Abierto",
        alertBrowserAlreadyOpenMsg: "Parece que BRAVE ya está abierto normalmente. Para que el programa controle las pestañas, todas las ventanas del navegador deben estar completamente cerradas y reiniciadas en modo de control.\n\n¿Quieres que el programa cierre el navegador y lo reinicie automáticamente? (El navegador te pedirá \"Restaurar\" las pestañas abiertas)",
        alertSyncTitle: "Activar Modo de Control y Sincronización",
        alertSyncMsg: "Para que el programa controle y sincronice las pestañas, BRAVE debe estar completamente cerrado y reiniciado en modo de control.\n\n¿Deseas cerrar el navegador ahora y volver a abrirlo?",
        alertLaunchError: "Ocurrió un error inesperado al iniciar el navegador. Asegúrate de cerrar cualquier otra sesión de navegación.",
        uploadBtnTitle: "Adjuntar fotos o documentos",
        fileSizeError: "El archivo es demasiado grande (máximo 15 MB)",
        
        syncing: "Sincronizando...",
        syncSuccess: "La sincronización y la apertura de pestañas se completaron con éxito. Inicia sesión manualmente si es necesario.",
        alertWarning: "Advertencia",
        enterQuestionFirst: "Por favor, escribe tu pregunta primero.",
        selectOneAgent: "Selecciona al menos una IA a la que transmitir.",
        stepBroadcastLoading: "Transmitiendo la pregunta a las pestañas abiertas...",
        stepCollectPending: "Esperando para recopilar respuestas (ChatGPT, Gemini, DeepSeek)...",
        stepSynthPending: "Enviando respuestas a Claude para un resumen unificado...",
        broadcastingAndCollecting: "Transmitiendo y Recopilando...",
        stepBroadcastCompleted: "Pregunta transmitida a todas las pestañas.",
        stepCollectLoading: "Esperando y obteniendo respuestas de IA...",
        errorProcessing: "Ocurrió un error al procesar la solicitud.",
        stepCollectCompleted: "Respuestas de IA extraídas con éxito.",
        stepSynthLoading: "Unificando y sintetizando respuestas a través de Claude...",
        stepSynthCompleted: "Síntesis y fusión completadas con éxito.",
        stepSynthSkippedMissing: "Síntesis omitida porque la pestaña de Claude no está disponible.",
        stepSynthSkippedOff: "La opción de síntesis está deshabilitada.",
        operationFailedTitle: "Operación Fallida",
        operationFailedMsg: "Error al transmitir y recopilar datos.",
        copied: "¡Copiado!",
        themeBtnDark: "Oscuro",
        themeBtnLight: "Claro",
        statusDisabled: "Este modelo ha sido desactivado en las opciones.",
        statusNoAnswer: "Este modelo no ha devuelto ninguna respuesta o se ha producido un error.",

        modeInstant: "Instantáneo",
        modeExpert: "Spark",
        selectAssistantLabel: "Elige un asistente para el chat:",
        toggleSidebarTitle: "Alternar barra lateral",
        searchChatsTitle: "Buscar chats",
        newChatBtnTitle: "Nuevo chat",
        searchHistoryPlaceholder: "Buscar chats...",
        welcomeInstant: "Comienza a chatear con Instant",
        welcomeExpert: "Comienza a chatear con Spark",
        promptPlaceholderChatgpt: "Mensaje a ChatGPT...",
        promptPlaceholderGemini: "Mensaje a Gemini...",
        promptPlaceholderDeepseek: "Mensaje a DeepSeek..."
    },
    de: {
        pageTitle: "AI Spark",
        subTitle: "Lokaler intelligenter Koordinator",
        braveBrowser: "Brave Browser",
        ...
        today: "Heute",
        yesterday: "Gestern",
        previous7: "Vorherige 7 Tage",
        older: "Älter",
        dashboardTitle: "Verteiltes Broadcast-Dashboard",
        dashboardDesc: "Geben Sie Ihre Frage ein und das System sendet sie gleichzeitig an ChatGPT, Gemini und DeepSeek und fasst sie dann lokal über Claude zusammen.",
        promptPlaceholder: "Geben Sie hier Ihre Frage im Detail ein... (z. B. Erklären Sie Cloud-Computing und seine Arten?)",
        claudeSynthesisToggle: "Zusammenführung und Zusammenfassung via Claude",
        sendPromptBtn: "Frage senden & Antworten sammeln",
        progressTitle: "Sende- und Sammelprozess läuft...",
        stepBroadcast: "Frage an offene Tabs senden...",
        stepCollect: "Warten auf Antworten (ChatGPT, Gemini, DeepSeek)...",
        stepSynth: "Antworten an Claude zur einheitlichen Zusammenfassung senden...",
        unifiedAnswerTitle: "Einheitliche und verbesserte Endantwort (Claude Synthesized)",
        copyBtn: "Kopieren",
        chatgptAnswer: "ChatGPT",
        geminiAnswer: "Gemini",
        deepseekAnswer: "DeepSeek",
        footerText: "100% lokal erstellt ohne kostenpflichtige APIs",
        clearHistoryBtn: "Verlauf löschen",
        clearHistoryConfirm: "Möchten Sie den gesamten Chatverlauf wirklich löschen?",
        modalAlertTitle: "Warnung",
        modalAlertMsg: "Bitte stellen Sie sicher, dass der Browser läuft und die erforderlichen Tabs geöffnet sind.",
        modalCancelBtn: "Abbrechen",
        modalOkBtn: "OK",
        
        alertError: "Fehler",
        alertSuccess: "Erfolg",
        alertSelectAgent: "Bitte wählen Sie mindestens einen KI-Assistenten aus.",
        alertEnterQuestion: "Bitte schreiben Sie Ihre Frage, bevor Sie sie senden.",
        alertCopySuccess: "Text in die Zwischenablage kopiert!",
        alertBrowserAlreadyOpenTitle: "Browser bereits geöffnet",
        alertBrowserAlreadyOpenMsg: "Es scheint, dass BRAVE bereits normal geöffnet ist. Damit das Programm die Tabs steuern kann, müssen alle Browserfenster vollständig geschlossen und im Steuerungsmodus neu gestartet werden.\n\nMöchten Sie, dass das Programm den Browser schließt und automatisch neu startet? (Der Browser fordert Sie auf, offene Tabs „wiederherzustellen“)",
        alertSyncTitle: "Steuerungs- und Sync-Modus aktivieren",
        alertSyncMsg: "Damit das Programm Tabs steuern und synchronisieren kann, muss BRAVE vollständig geschlossen und im Steuerungsmodus neu gestartet werden.\n\nMöchten Sie den Browser jetzt schließen und wieder öffnen?",
        alertLaunchError: "Beim Starten des Browsers ist ein unerwarteter Fehler aufgetreten. Schließen Sie alle anderen Browsersitzungen.",
        uploadBtnTitle: "Fotos oder Dokumente anhängen",
        fileSizeError: "Datei ist zu groß (maximal 15 MB)",
        
        syncing: "Synchronisieren...",
        syncSuccess: "Synchronisierung und Tab-Öffnung erfolgreich abgeschlossen. Bitte melden Sie sich bei Bedarf manuell an.",
        alertWarning: "Warnung",
        enterQuestionFirst: "Bitte geben Sie zuerst Ihre Frage ein.",
        selectOneAgent: "Bitte wählen Sie mindestens eine KI aus.",
        stepBroadcastLoading: "Frage an offene Tabs senden...",
        stepCollectPending: "Warten auf Antworten (ChatGPT, Gemini, DeepSeek)...",
        stepSynthPending: "Antworten an Claude zur einheitlichen Zusammenfassung senden...",
        broadcastingAndCollecting: "Senden und Sammeln...",
        stepBroadcastCompleted: "Frage an alle Tabs gesendet.",
        stepCollectLoading: "Warten auf KI-Antworten...",
        errorProcessing: "Beim Verarbeiten der Anfrage ist ein Fehler aufgetreten.",
        stepCollectCompleted: "KI-Antworten erfolgreich extrahiert.",
        stepSynthLoading: "Zusammenführung und Synthese von Antworten via Claude...",
        stepSynthCompleted: "Synthese und Zusammenführung erfolgreich abgeschlossen.",
        stepSynthSkippedMissing: "Synthese übersprungen, da der Claude-Tab nicht verfügbar ist.",
        stepSynthSkippedOff: "Die Syntheseoption ist deaktiviert.",
        operationFailedTitle: "Vorgang fehlgeschlagen",
        operationFailedMsg: "Fehler beim Senden und Sammeln von Daten.",
        copied: "Kopiert!",
        themeBtnDark: "Dunkel",
        themeBtnLight: "Hell",
        statusDisabled: "Dieses Modell wurde in den Optionen deaktiviert.",
        statusNoAnswer: "Dieses Modell hat keine Antwort zurückgegeben oder es ist ein Fehler aufgetreten.",

        modeInstant: "Instant",
        modeExpert: "Spark",
        selectAssistantLabel: "Wählen Sie einen Assistenten für den Chat:",
        toggleSidebarTitle: "Seitenleiste umschalten",
        searchChatsTitle: "Chats durchsuchen",
        newChatBtnTitle: "Neuer Chat",
        searchHistoryPlaceholder: "Chats durchsuchen...",
        welcomeInstant: "Beginnen Sie mit Instant zu chatten",
        welcomeExpert: "Beginnen Sie mit Spark zu chatten",
        promptPlaceholderChatgpt: "Nachricht an ChatGPT...",
        promptPlaceholderGemini: "Nachricht an Gemini...",
        promptPlaceholderDeepseek: "Nachricht an DeepSeek..."
    }
};
...
function getDefaultLang() {
    const saved = safeStorage.getItem("appLang", null);
...
function initApp() {
    ...
    if (clearHistoryBtn) {
        ...
        const newChatBtnTopSidebar = document.getElementById("new-chat-btn-top-sidebar");
        if (newChatBtnTopSidebar) {
            newChatBtnTopSidebar.addEventListener("click", handleNewChat);
        }

        // Sidebar toggle button
        const toggleSidebarBtns = [
            document.getElementById("toggle-sidebar-btn"),
            document.getElementById("toggle-sidebar-btn-sidebar")
        ];
        ...
        const searchHistoryBtns = [
            document.getElementById("search-history-btn"),
            document.getElementById("search-history-btn-sidebar")
        ];
